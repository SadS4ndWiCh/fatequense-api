...
import { schoolGradeSchema } from '~/libs/validations/school-grade';

import { withScraper } from '../utils/scraper.utils';
...
export const getStudentSchoolGrade = withScraper(($) => {
  ...
  return schoolGradeSchema.parse(semesters);
});
